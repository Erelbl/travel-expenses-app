...
export default function TripHomePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen pb-20 md:pb-6 bg-gradient-to-b from-sky-50/50 via-blue-50/30 to-slate-50/20" dir={isRTL ? "rtl" : "ltr"}>
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-6 bg-gradient-to-b from-sky-50/50 via-blue-50/30 to-slate-50/20" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="container mx-auto max-w-4xl px-4 py-5 space-y-6">
        ...
        {canAddExpense(trip) && (
          <div className="bg-white/98 backdrop-blur-sm rounded-xl border border-slate-200/60 p-3 shadow-sm shadow-slate-900/4">
        ...
        {canAddExpense(trip) && (
          <Link href={`/trips/${tripId}/batch-add`} className="block">
            <div className="flex items-center gap-3 p-4 bg-white/80 hover:bg-white backdrop-blur-sm border border-slate-200/60 rounded-xl transition-colors shadow-sm shadow-slate-900/4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {/* Total Spent */}
          <Card className="border-slate-200/60 shadow-sm shadow-slate-900/4 bg-white/98 backdrop-blur-sm">
          ...
          {/* Future Commitments */}
          <Card className={`shadow-sm shadow-slate-900/4 backdrop-blur-sm ${summary.totalFuture > 0 ? "border-amber-200/60 bg-amber-50/50" : "border-slate-200/60 bg-white/98"}`}>
            <CardContent className="p-4">
        ...
        {bannerInsight && !bannerDismissed && (
          <div className="relative bg-gradient-to-r from-amber-50/95 to-yellow-50/95 backdrop-blur-sm border border-amber-200/60 rounded-xl p-4 shadow-sm shadow-slate-900/4">
            <button
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Link href={`/trips/${tripId}/reports`} className="block">
            <div className="flex items-center gap-3 p-4 bg-white/80 hover:bg-white backdrop-blur-sm border border-slate-200/60 rounded-xl transition-colors h-full shadow-sm shadow-slate-900/4">
              <div className="w-9 h-9 rounded-lg bg-slate-200 flex items-center justify-center shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-3 p-4 bg-white/80 hover:bg-white backdrop-blur-sm border border-slate-200/60 rounded-xl transition-colors text-start w-full shadow-sm shadow-slate-900/4"
          >
        ...
        {/* Recent Expenses */}
        <Card className="border-slate-200/60 overflow-hidden shadow-sm shadow-slate-900/4 bg-white/98 backdrop-blur-sm">
