...
export default function BatchAddLoading() {
  return (
    <div className="min-h-screen pb-20 md:pb-6 bg-gradient-to-b from-sky-100/60 via-blue-100/40 to-slate-50/60">
      ...
      >
        ...
        <div className="container mx-auto max-w-3xl relative">
          <div className="p-4">
            <div className="h-6 w-40 bg-white/20 rounded-lg animate-pulse-slow" />
          </div>
        </div>
      </motion.div>
      ...
      <div className="container mx-auto max-w-3xl px-4 py-6">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="h-4 w-3/4 bg-slate-200/80 rounded animate-pulse relative overflow-hidden">
              <div className="absolute inset-0 -translate-x-full animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
            </div>
          </div>
          ...
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                <div className="h-10 bg-slate-200/80 rounded animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 -translate-x-full animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
                </div>
                <div className="h-10 bg-slate-200/80 rounded animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 -translate-x-full animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
