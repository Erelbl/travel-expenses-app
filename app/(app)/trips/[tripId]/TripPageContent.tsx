...
import { Plus, DollarSign, TrendingUp, Calendar, BarChart3, Zap, Coins, Filter, MapPin, X, Lightbulb, Settings, ArrowUpDown, Share2, Search } from "lucide-react"
...
export default function TripPageContent({ tripId }: { tripId: string }) {
