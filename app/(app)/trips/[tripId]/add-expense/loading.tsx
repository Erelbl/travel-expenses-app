    ...
    <div className="min-h-screen pb-20 md:pb-6 bg-gradient-to-b from-sky-100/60 via-blue-100/40 to-slate-50/60">
      ...
      >
        ...
        <div className="container mx-auto max-w-2xl relative">
          <div className="p-4">
            <div className="h-6 w-36 bg-white/20 rounded-lg animate-pulse-slow" />
          </div>
        </div>
      </motion.div>
      ...
      <div className="container mx-auto max-w-2xl px-4 py-6">
        ...
        >
          ...
          >
            <div className="h-11 flex-1 bg-slate-200/80 rounded-lg animate-pulse relative overflow-hidden">
              <div className="absolute inset-0 -translate-x-full animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
            </div>
            <div className="h-11 flex-1 bg-sky-200/80 rounded-lg animate-pulse relative overflow-hidden">
              <div className="absolute inset-0 -translate-x-full animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
            </div>
          </motion.div>
        </motion.div>
