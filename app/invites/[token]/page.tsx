          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3 p-4 bg-blue-50 border border-blue-200 rounded-xl">
              <p className="text-sm text-slate-700 text-center">
                {t("join.signInPrompt")} <strong>{invitation.invitedEmail}</strong>
              </p>
            </div>

            <div className="flex flex-col gap-3">
              <Link href={`/auth/login?callbackUrl=/invites/${token}`}>
                <Button size="lg" className="w-full">
                  {t("auth.signIn")}
                </Button>
              </Link>
              
              <Link href={`/auth/signup?callbackUrl=/invites/${token}`}>
        ...
        <Card className="max-w-md w-full">
          <CardContent className="pt-6 text-center">
            ...
            <div className="flex flex-col gap-3 mt-6">
              ...
              <Button variant="ghost" onClick={() => router.push("/trips")} className="text-slate-500">
